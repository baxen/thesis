...
Primary vertices are reconstructed by iteratively identifying seeds from reconstructed tracks.
...
Another scale is defined for hadronic processes, the \ac{LCW} scale, that helps to correct for the expected variations in hadronic energy deposits from effects like the differing proportions of \piz, \pip, and \pim in the shower. 
...
Then, all showers are corrected...
