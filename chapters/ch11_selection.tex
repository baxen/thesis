...
The major losses of signal events occur first because of acceptance as only about 65\% of events produce a charged \rhadron and in the metastable case only some of those particles propagate through the pixel detector depending on the lifetime.
The losses in efficiency come primarily from requiring a well-measured, high-momentum track.
