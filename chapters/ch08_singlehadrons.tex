...
These results are measured in terms of \epcor$^{EM}$, where EM designates that only clusters in the electromagnetic calorimter are included and COR designates that the neutral background is subtracted as the neutral background is present in this case.
