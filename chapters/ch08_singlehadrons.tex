...
A number of interesting factors compromise calorimeter response, and extracting these separately provides insight into many aspects of jet modeling.
...
This last dataset was also used in the 2010 results~\cite{PERF-2011-05}, but it has since been reanalyzed with an updated detector description for the material and alignment.
...
Though the distribution of \ep is interesting, two aggregated quantities are more directly useful: \epav, the average of \ep within a given subset of particles, and the zero fraction, the fraction of particles with no associated energy in the calorimeter.
...
Nearby neutral particles deposit (sometimes large) additional energy in the calorimeter but do not produce tracks in the inner detector, so they cannot be rejected for isolation.
...
\centering
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/dvmc_epcor_layer01_calib01_eta01_q00_nc00_trt02.pdf}
}
~
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/dvmc_epcor_layer01_calib01_eta02_q00_nc00_trt02.pdf}
}
\\
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/dvmc_epcor_layer01_calib01_eta06_q00_nc00_trt02.pdf}
}
~
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/dvmc_epcor_layer01_calib01_eta07_q00_nc00_trt02.pdf}
}
...
\centering
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/dvmc_epcor_layer01_calib02_eta01_q00_nc00_trt02.pdf}
}
~
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/dvmc_epcor_layer01_calib02_eta01_q00_nc02_trt02.pdf}
}
...
\centering
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/trt_dvmc_epcor_layer01_calib01_eta01_q00_nc00_trt01.pdf}
}
~
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/trt_dvmc_epcor_layer01_calib01_eta01_q00_nc00_trt02.pdf}
}
...
\centering
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/dvmc_epcor_layer01_calib01_eta01_q02_nc00_trt02.pdf}
}
~
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/dvmc_epcor_layer01_calib01_eta01_q01_nc00_trt02.pdf}
}
...
\centering
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/eoverp_TOT_eta01_p03_q02_MC.pdf}
}
~
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/eoverp_TOT_eta01_p03_q01_MC.pdf}
}
...
As the layers are composed of different materials and are modeled separately in the detector geometry, confirm that the simulation matches the data well in each layer adds confidence in both the description of hadronic interactions with the two different materials and also the geometric description of each. 

The technique discussed in Section~\ref{sec:neutral_bg} for selection minimally ionizing particles (MIPs) in the electromagnetic calorimeter is also useful in studying deposits in the hadronic calorimeter.
Those MIPs deposit almost all of their energy exclusively in the hadronic calorimeter.
...
The data and simulation agree very well in this comparison, except in the lowest momentum bin which has 5\% discrepancy that has been reflected in similar results.

\begin{figure}[h]
\centering
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/EPvsP_raw_HCal_EMscale_eta_06.pdf}
}
~
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/EPvsP_raw_HCal_LCW_eta_06.pdf}
}
...
These results are measured in terms of \epav$_{\mathrm{COR}}^{\mathrm{EM}}$, where EM designates that only clusters in the electromagnetic calorimter are included and COR designates that the neutral background is subtracted as the neutral background is present in this case.
Figure~\ref{fig:epcor_ecal} shows the analagous comparisons to Figure~\ref{fig:epav_hcal} in the electromagnetic calorimeter.
...
\centering
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/EPvsP_cor_ECal_EMscale_eta_06.pdf}
}
~
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/EPvsP_cor_ECal_LCW_eta_06.pdf}
}
...
\centering
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/mass_kshort_eta01.pdf}
}
\\
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/mass_lambda_eta01.pdf}
}
~
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/mass_lambdabar_eta01.pdf}
}
\caption{The reconstructed mass peaks of (a) \pKS, (b) \pL, and (c) \pLB candidates.}
\label{fig:identified_mass}
\end{figure}

There are a number of sources of backgrounds for these identified particles, including nuclear interactions and combinatoric sources.
...
\centering
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/dvmc12r_eoverp_pip_eta01_p05.pdf}
}
~
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/dvmc12r_eoverp_pim_eta01_p05.pdf}
}
\\
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/dvmc12r_eoverp_protonp_eta01_p05.pdf}
}
~
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/dvmc12r_eoverp_protonm_eta01_p05.pdf}
}
...
\centering
\subfloat[]{
  \includegraphics[width = 0.48\textwidth]{figures/ep_zero_pions_eta01.pdf}
}
~
\subfloat[]{
  \includegraphics[width = 0.48\textwidth]{figures/ep_zero_protons_eta01.pdf}
}
...
\centering
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/dvmc12r_epdiff_ea_pip_pim_eta01.pdf}
}
\\
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/dvmc12r_epdiff_ea_protonp_pip_eta01.pdf}
}
~
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/dvmc12r_epdiff_ea_protonm_pim_eta01.pdf}
}
...
\centering
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/dvmc12r_epcor_p_pip_eta01.pdf}
}
\subfloat[]{
  \includegraphics[width=0.48\textwidth]{figures/dvmc12r_epcor_p_pim_eta01.pdf}
}
