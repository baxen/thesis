...
\graffito{This appendix is temporary and is here to be used to check the style of the document.}


Examples: \textit{Italics}, \textsc{Small Caps}, \spacedallcaps{All Caps} \footnote{Footnote example.}.
...
There is also a Python listing below~\autoref{lst:useless}.
